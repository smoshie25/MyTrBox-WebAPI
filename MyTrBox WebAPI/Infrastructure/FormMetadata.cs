    ...
    public static class FormMetadata
    {
        ...
        public static Form FromResource<T>(Link self)
        {
            ...
            if (searchableProperties.Any())
            {
                ...
                var nameGroup = $"{string.Join("|", searchableProperties.Select(x => x.Name))}";
            ...
            if (orderByOptions.Any())
            {
                formFields.Add(new FormField
                {
                    Name = nameof(SortOptions<string, string>.OrderBy),
                    Type = "set",
            ...
            if (!string.IsNullOrEmpty(searchPattern))
            {
                formFields.Add(new FormField
                {
                    Name = nameof(SearchOptions<string, string>.Search),
                    Type = "set",
